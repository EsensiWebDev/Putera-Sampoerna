                ...
                <ul class="navbar-nav ms-auto">
                    <li
                        ...
                        <a class="nav-link fs-5 link-body-emphasis" aria-label="Going To About Us"
                            href="{{ route('aboutus', ['locale' => app()->getLocale()]) }}"
                        ...
                        <div class="nav-item dropdown" style="font-family: Campton;"><a class="fs-5 link-body-emphasis"
                                aria-expanded="false" data-bs-toggle="dropdown" aria-label="Expands About Us"
                                href="aboutus.html" style="color: var(--bs-white);">
                            ...
                            <div class="dropdown-menu dropdown-menu-end"
                                style="padding-left: 8px;padding-right: 8px;border-radius: 0px;"><a
                                    ...
                                    href="{{ route('aboutus.ourjourney', ['locale' => app()->getLocale()]) }}">{{ __('Our Journey') }}</a>
                                ...
                                <a class="dropdown-item fw-light" aria-label="Going To Board Member"
                                    href="{{ route('aboutus.boardmember', ['locale' => app()->getLocale()]) }}">{{ __('Board Members') }}</a>
                            </div>
                        </div>
                    </li>
                    <li
                        ...
                        <a class="nav-link fs-5 link-body-emphasis" aria-label="Going To Our Pilar"
                            href="{{ route('ourpillar', ['locale' => app()->getLocale()]) }}"
                            style="font-family: Campton;padding-right: 0px;">{{ __('Our Pillar') }}</a>
                        <div class="nav-item dropdown" style="font-family: Campton;"><a class="fs-5 link-body-emphasis"
                                aria-expanded="false" data-bs-toggle="dropdown" aria-label="Expands Our PIllar"
                            ...
                            <div class="dropdown-menu dropdown-menu-end"
                                ...
                                <a class="dropdown-item fw-light" aria-label="Going To School System"
                                    href={{ route('ourpillar.sampoerna-school-system', ['locale' => app()->getLocale()]) }}>{{ __('Sampoerna School System') }}</a>
                                <div class="dropdown-divider"
                                ...
                                <a class="dropdown-item fw-light" aria-label="Going To School Dev"
                                    href="{{ route('ourpillar.school-development', ['locale' => app()->getLocale()]) }}">{{ __('School Development Outreach') }}</a>
                                <div class="dropdown-divider"
                                    style="margin: 8px 14px;border-width: 1px;border-color: rgb(0,0,0);"></div>
                                <a class="dropdown-item fw-light" aria-label="Going To Scholarship"
                                    href="{{ route('ourpillar.scholarship', ['locale' => app()->getLocale()]) }}">{{ __('Scholarship') }}</a>
                            </div>
                        </div>
                    </li>
                    <li
                        ...
                        <a class="nav-link fs-5 link-body-emphasis" aria-label="Going To Partners"
                            href="{{ route('partners', ['locale' => app()->getLocale()]) }}"
                        ...
                        <div class="nav-item dropdown" style="font-family: Campton;"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-end"
                                style="padding-left: 8px;padding-right: 8px;border-radius: 0px;"><a
                                    ...
                                    href="{{ route('partners.government-sector', ['locale' => app()->getLocale()]) }}">{{ __('Government Sectors') }}</a>
                                <div class="dropdown-divider"
                                ...
                                <a class="dropdown-item fw-light" aria-label="Going To Private Sector"
                                    href="{{ route('partners.private-sector', ['locale' => app()->getLocale()]) }}">{{ __('Private Sector') }}</a>
                                <div class="dropdown-divider"
                                    style="border-width: 1px;border-color: rgb(0,0,0);margin: 8px 14px;"></div>
                                <a class="dropdown-item fw-light" aria-label="Going To Involve"
                                    href="{{ route('partners.how-to-involve', ['locale' => app()->getLocale()]) }}">{{ __('How to Involve') }}</a>
                            </div>
                        </div>
                    </li>
                    <li
                        ...
                        <div class="nav-item dropdown" style="font-family: Campton;"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-end"
                                ...
                                <a class="dropdown-item fw-light" aria-label="Going To Annual Report"
                                    href="{{ route('media.annual-reports', ['locale' => app()->getLocale()]) }}">{{ __('Annual Reports') }}</a>
                            </div>
                        </div>
                    </li>

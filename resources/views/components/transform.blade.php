    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 40px;">
            <div
                ...
                <div class="px-0 py-0 me-3"><img src="{{ asset("assets/img/Icon/Map%20Pin.svg") }}" width="40" height="40"></div>
                <div>
            ...
            <div
                class="col d-flex flex-row justify-content-center align-items-center justify-content-lg-center col-6 col-sm-6 col-lg-4 px-0 py-0 my-3">
                <div class="px-0 py-0 me-3"><img src="{{ asset("assets/img/Icon/Schools.svg") }}" width="40" height="40"></div>
                <div>
            ...
            <div
                class="col d-flex flex-row justify-content-center align-items-center justify-content-lg-center col-6 col-sm-6 col-lg-4 px-0 py-0 my-3">
                <div class="px-0 py-0 me-3"><img src="{{ asset("assets/img/Icon/Donors.svg") }}" width="40" height="40"></div>
                <div>
            ...
            <div
                class="col d-flex flex-row justify-content-center align-items-center justify-content-lg-center col-6 col-sm-6 col-lg-4 px-0 py-0 my-3">
                <div class="px-0 py-0 me-3"><img src="{{ asset("assets/img/Icon/Students.svg") }}" width="40" height="40"></div>
                <div>
            ...
            <div
                class="col d-flex flex-row justify-content-center align-items-center justify-content-lg-center col-6 col-sm-6 col-lg-4 px-0 py-0 my-3">
                <div class="px-0 py-0 me-3"><img src="{{ asset("assets/img/Icon/Parents.svg") }}" width="40" height="40"></div>
                <div>
            ...
            <div
                class="col d-flex flex-row justify-content-center align-items-center justify-content-lg-center col-6 col-sm-6 col-lg-4 px-0 py-0 my-3">
                <div class="px-0 py-0 me-3"><img src="{{ asset("assets/img/Icon/Teachers.svg") }}" width="40" height="40"></div>
                <div>

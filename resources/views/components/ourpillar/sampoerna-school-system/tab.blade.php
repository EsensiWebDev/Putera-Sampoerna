<section style="margin-top: 200px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="fs-2" style="text-align: center;font-family: Campton;">{{ __("How We're Making a Difference") }}</h1>
            </div>
        </div>
        <div class="d-flex flex-column align-items-xxl-center">
            ...
            <div class="tab-content">
                <div class="tab-pane active" role="tabpanel" id="tab-1">
                    <div class="row my-5 mb-0 mt-3" style="margin-top: 150px;">
                        <div class="col-md-6 py-3">
                            <div class="d-flex flex-row">
                                <div class="col-xxl-5" style="width: 229px;"><img class="img-fluid" src="{{ asset("assets/img/Our%20Pillar/Jonah.webp") }}" width="229px" height="324px" alt="Jonah" style="height: 324px;"></div>
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4">
                                        <div><span class="pe-0" style="padding-right: 0px;"><img width="58.16px" height="45.72px" src="{{ asset("assets/img/Our%20Pillar/stroke.webp") }}" alt="stroke" class="me-0" style="padding-right: 0px;"></span>
                                            <h1 class="fs-5 mb-0 ps-0" style="font-family: Campton;color: #1C1C28;margin-top: -32px;padding-top: 14px;">&nbsp;{{ __("What I love about Sampoerna Academy is the trilingual environment") }}</h1>
                                        </div>
                                        <p class="my-2">{{ __("where we can speak English, Bahasa, and Mandarin. The Bahasa teacher is always helpful in translating words I don't know during class.") }}</p>
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Jonah</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 py-3">
                            <div class="d-flex flex-row">
                                <div class="col-xxl-4" style="width: 229px;height: 324px;"><img class="img-fluid" src="{{ asset("assets/img/Our%20Pillar/Mattheo.webp") }}" style="width: 229px;height: 324px;" width="229px" height="324px" alt="Matheo"></div>
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4"><span class="pe-0" style="padding-right: 0px;"><img width="58.16px" height="45.72px" src="{{ asset("assets/img/Our%20Pillar/stroke.webp") }}" alt="stroke" class="me-0" style="padding-right: 0px;"></span>
                                        <div>
                                            <h1 class="fs-5 mb-0" style="font-family: Campton;color: #1C1C28;margin-top: -14px;">{{ __("I choose Sampoerna University") }}<br>{{ __("because I realized that it has") }}<br>{{ __("really diverse community.") }}</h1>
                                        </div>
                                        <p class="my-2">{{ __("The reason why I'm majoring Business Management is because it aligned with what I studied in high school and it also picked an interest in me.") }}</p>
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Mattheo Alexander</h1>
                                        <p class="my-2">{{ __("Business Management") }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4">
                                        ...
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Mr. Heize</h1>
                                        <p class="my-2">{{ __("Math Teacher, Sampoerna Academy") }} <br>L'Avenue</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4"><span class="pe-0" style="padding-right: 0px;"><img width="58.16px" height="45.72px" src="{{ asset("assets/img/Our%20Pillar/stroke.webp") }}" alt="stroke" class="me-0" style="padding-right: 0px;"></span>
                                        ...
                                        <p class="my-2">{{ __("This approach makes learning more engaging and fun, helping students develop communication and critical thinking skills.") }}</p>
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Anak Agung Ngurah Perwira Redi</h1>
                                        <p class="my-2">{{ __("Head of Industrial Engineering Study Program &Lecturer") }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4">
                                        ...
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Melaney &amp; Tyson</h1>
                                        <p class="my-2">{{ __("Parents of Chloe Lynch, Sampoerna Academy L'Avenue") }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4"><span class="pe-0" style="padding-right: 0px;"><img width="58.16px" height="45.72px" src="{{ asset("assets/img/Our%20Pillar/stroke.webp") }}" alt="stroke" class="me-0" style="padding-right: 0px;"></span>
                                        ...
                                        <p class="my-2">{{ __("which convinced me to enroll Lydia to pursue her higher education here. From what I observed, Lydia has grown more confidence since studying here, she is also brave to speak in front of public.") }}</p>
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Budi Hartanto</h1>
                                        <p class="my-2">{{ __("Parent of Theodora Sihar Lydia Hartanto (MGMT 2019)") }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4">
                                        ...
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Puti Yasmina</h1>
                                        <p class="my-2">{{ __("Sampoerna Academy L'Avenue") }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center px-xxl-0 px-0">
                                    <div class="px-2 px-xxl-4"><span class="pe-0" style="padding-right: 0px;"><img width="58.16px" height="45.72px" src="{{ asset("assets/img/Our%20Pillar/stroke.webp") }}" alt="stroke" class="me-0" style="padding-right: 0px;"></span>
                                        ...
                                        <p class="my-2">{{ __("and professional professors that supports my learning journey. From this program, I gained real-world experience by applying what I've learned in practical settings.") }}</p>
                                        <h1 style="font-family: Campton;color: #1C1C28;" class="mb-0">Jauharul</h1>
                                        <p class="my-2">{{ __("Sampoerna University Alumni") }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>

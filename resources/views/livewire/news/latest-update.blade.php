        ...
        <div class="row">
            ...
            @if(isset($article))
                <div class="col-md-6 px-0 py-0">
                    <div class="card py-3" style="border-radius: 0px;border-style: none;"><img
                            ...
                            src="{{ str_contains($article->thumbnail, '/uploads') ? asset($article->thumbnail) : asset('storage/' . $article->thumbnail) }}" width="749px" height="646px"
                            alt="Beasiswa">
            ...
            <div class="col-md-6 py-2 mx-0 px-0">
                @if(isset($articles) && $articles->count() > 1)
                    ...
                    <div class="col">
                        <div style="background: url({{ str_contains($article->thumbnail, '/uploads') ? asset($article->thumbnail) : asset('storage/' . $article->thumbnail) }}) center / cover no-repeat;height: 232px;"></div>
                    </div>

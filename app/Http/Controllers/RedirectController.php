...
class RedirectController extends Controller
{
  ...
  public function redirect_to_news($locale, $slug, Request $request): Response|RedirectResponse
  {
    ...
    $articles_list_indo = [
      ...
      '450-guru-dan-110-pelajar-di-samarinda-mendapat-pemerataan-akses-pendidikan',
      '450-guru-paud-hingga-smp-berpartisipasi-dalam-diseminasi-guru',
      ...
      'hadir-di-ubud-writers-readers-festival-2022-sampoerna-academy-inspirasi-literasi',
      'hari-pendidikan-nasional',
      'kecerdasan-budaya-kompetensi-bahasa-kecakapan-abad-21',
      'klarifikasi-menanggapi-artikel-di-kompasiana-tertanggal-18-mei-2014',
      'klarifikasi-pemberitaan-psf-di-media-blog-kompasiana',
      'ksb-industrial-visit-memahami-pentingnya-teknologi',
      'kurikulum-merdeka-definisi-penerapan-dan-fungsinya',
      'landasan-pendidikan-di-indonesia',
      'lebih-dari-30000-guru-di-wilayah-3t-kembangkan-potensi-profesi',
      'masalah-tantangan-pendidikan-yang-dihadapi-indonesia',
      'membangun-smpn-8-singaraja-menjadi-sekolah-berbasis-digital',
      ...
      'sampoerna-academy-dorong-generasi-alpha-menghargai-keberagaman',
      ...
      'tingkatkan-kecintaan-terhadap-laut-workshop-save-the-ocean',
      'tingkatkan-kualitas-pendidikan-pt-penjaminan-infrastruktur-indonesia',
      'tujuan-pendidikan-nasional',
      'zainal-abidin-seorang-guru-yang-mengarungi-sungai-kapuas',
    ];
